...
| [deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) | [@ningbainb](https://github.com/ningbainb) | DeepSeek Harness 的开源 Windows 桌面客户端与 GUI：零配置安装，集成 Codex、插件、技能、SSH、移动端远程访问，并内置 11 款皮肤。 |
