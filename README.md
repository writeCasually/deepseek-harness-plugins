...
| [dsh-data-agent](https://github.com/omdsh-dev/dsh-data-agent) | English \| 中文（隐私风险：访问第三方网络地址；读取浏览器 Cookie/存储并发送到网络；读取环境变量（可能包含敏感信息）） | `dsh plugin --profile web add github:omdsh-dev/dsh-data-agent` |
...
| [dsh-find-plugin](https://github.com/awesome-dsh-plugin/dsh-find-plugin) | English \| 中文（隐私风险：访问第三方网络地址）（安全提示：存在疑似混淆内容） | `dsh plugin --profile web add github:awesome-dsh-plugin/dsh-find-plugin` |
...
| [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) | > 中文 \| English \| 更新日志（隐私风险：访问第三方网络地址；读取浏览器 Cookie/存储并发送到网络） | `dsh plugin --profile web add github:lire1131/dsh-undo-plugin` |
...
| [dsh-lark](https://github.com/omdsh-dev/dsh-lark) | 简体中文 \| English（隐私风险：访问第三方网络地址）（安全提示：存在疑似混淆内容；使用动态代码或子进程执行） | `dsh plugin --profile web add github:omdsh-dev/dsh-lark` |
| [dsh-plugin-workshop](https://github.com/yyyyukari/dsh-plugin-workshop) | 简体中文 \| English（隐私风险：访问第三方网络地址；读取浏览器 Cookie/存储并发送到网络）（安全提示：使用动态代码或子进程执行） | `dsh plugin --profile web add github:yyyyukari/dsh-plugin-workshop` |
...
| [dsh-plugin-cc](https://github.com/cpj-dev/dsh-plugin-cc) | English \| 简体中文（隐私风险：访问第三方网络地址；读取环境变量（可能包含敏感信息）） | `dsh plugin --profile web add github:cpj-dev/dsh-plugin-cc` |
...
| [dsh-plugin-marketplace](https://github.com/AwesomeHou/dsh-plugin-marketplace) | English \| 中文（隐私风险：访问第三方网络地址；读取凭据类环境变量并发送到网络，可能泄露密钥）（安全提示：使用动态代码或子进程执行） | `dsh plugin --profile web add github:AwesomeHou/dsh-plugin-marketplace` |
| [dshcode](https://github.com/whitelonng/dshcode) | English \| 中文（隐私风险：访问第三方网络地址） | `dsh plugin --profile web add github:whitelonng/dshcode` |
| [dsh-plugin-template](https://github.com/bugmaker2/dsh-plugin-template) | English \| 中文（安全提示：存在疑似混淆内容） | `dsh plugin --profile web add github:bugmaker2/dsh-plugin-template` |
| [dsh-share](https://github.com/hellodigua/dsh-share) | 简体中文 \| English（隐私风险：访问第三方网络地址；读取浏览器 Cookie/存储并发送到网络；读取环境变量并访问第三方地址，需确认未外发敏感信息）（安全提示：使用动态代码或子进程执行；存在 Base64 解码行为；存在疑似混淆内容） | `dsh plugin --profile web add github:hellodigua/dsh-share` |
