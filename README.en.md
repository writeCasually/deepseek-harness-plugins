...
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | [@Minglink](https://github.com/Minglink) | DeepSeek 专用破甲插件「无限三代」dsh-infinite-gen-3 — armor-breaking plugin for DeepSeek，破甲版：稳定化破甲，求 Star 收藏 ⭐ |
| [dsh-infinite-gen-4](https://github.com/Minglink/dsh-infinite-gen-4) | [@Minglink](https://github.com/Minglink) | DeepSeek v4.1 flash 网络安全红队工具（无限四代） — jailbreak prompts and test suite for DeepSeek    求 Star 收藏 ⭐欢迎大家提交项目的改进 |
...
| [Wegent](https://github.com/wecode-ai/Wegent) | [@wecode-ai](https://github.com/wecode-ai) | Plan, build, and deliver with an open-source, self-hostable AI workspace for coding, collaboration, and automation. |
...
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | [@LivXue](https://github.com/LivXue) | The most comprehensive DeepSeek Harness plugin market — refreshed daily, sourced across the Internet, reviewed before publishing. |
...
| [ANOLISA](https://github.com/agentic-os-org/ANOLISA) | [@agentic-os-org](https://github.com/agentic-os-org) | ANOLISA (Agentic Nexus Operating Layer & Interface System Architecture) \| Agentic OS with runtime, security, observability, and Tokenless response compression for lower token usage and cost. |
...
| [thoughtdag](https://github.com/chenxiachan/thoughtdag) | [@chenxiachan](https://github.com/chenxiachan) | Your thinking deserves a map: an infinite canvas where LLM conversations grow into an editable thought graph. Wires are the context. |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | [@1692775560](https://github.com/1692775560) | Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献管理、实验追踪、指标图表、GPU 服务器 SSH 任务编排，管理科研全周期。An open-source research workbench plugin for the whole research cycle. |
| [jingyun-dsh](https://github.com/jingyunstudio/jingyun-dsh) | [@jingyunstudio](https://github.com/jingyunstudio) | 基于 Jingyun Studio + DeepSeek Harness (DSH) 打造的一站式 AI 商业化桌面客户端 |
...
Includes 208 plugins, official plugins first; see [docs/plugins.json](docs/plugins.json) for source and update time.
